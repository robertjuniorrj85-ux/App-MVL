import { firebaseConfig } from './firebase-config.js?v=10.0';
...
async function enviarFotoPerfil(file){
  ...
  await refreshCaches();return result;
}
async function excluirFotoPerfil(){
  ...
  currentUserData={...currentUserData,fotoUrl:''};await refreshCaches();
}
