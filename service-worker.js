const CACHE='mvl-v9-3';
const STATIC=[
  './index.html?v=9.3','./styles.css?v=9.3','./app.js?v=9.3','./firebase-config.js?v=9.3',
  './manifest.webmanifest?v=9.3','./logo-mvl.jpg','./mvl-icon-192-v4.png','./mvl-icon-512-v4.png'
];
