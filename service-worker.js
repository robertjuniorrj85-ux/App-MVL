const CACHE='mvl-v10-0-1';
const STATIC=[
  './index.html?v=10.0.1','./styles.css?v=10.0.1','./app.js?v=10.0.1','./firebase-config.js?v=10.0.1',
  './manifest.webmanifest?v=10.0.1','./logo-mvl.jpg','./mvl-icon-192-v4.png','./mvl-icon-512-v4.png'
];
