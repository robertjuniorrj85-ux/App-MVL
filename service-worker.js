const CACHE='mvl-v10-0';
const STATIC=[
  './index.html?v=10.0','./styles.css?v=10.0','./app.js?v=10.0','./firebase-config.js?v=10.0',
  './manifest.webmanifest?v=10.0','./logo-mvl.jpg','./mvl-icon-192-v4.png','./mvl-icon-512-v4.png'
];
