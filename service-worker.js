const CACHE='mvl-v9-6';
const STATIC=[
  './index.html?v=9.6','./styles.css?v=9.6','./app.js?v=9.6','./firebase-config.js?v=9.6',
  './manifest.webmanifest?v=9.6','./logo-mvl.jpg','./mvl-icon-192-v4.png','./mvl-icon-512-v4.png'
];
