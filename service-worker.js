const CACHE='mvl-v10-1';
const STATIC=[
  './index.html?v=10.1','./styles.css?v=10.1','./app.js?v=10.1','./firebase-config.js?v=10.1',
  './manifest.webmanifest?v=10.1','./logo-mvl.jpg','./mvl-icon-192-v4.png','./mvl-icon-512-v4.png'
];
