const CACHE='mvl-v9-6-1';
const STATIC=[
  './index.html?v=9.6.1','./styles.css?v=9.6.1','./app.js?v=9.6.1','./firebase-config.js?v=9.6.1',
  './manifest.webmanifest?v=9.6.1','./logo-mvl.jpg','./mvl-icon-192-v4.png','./mvl-icon-512-v4.png'
];
